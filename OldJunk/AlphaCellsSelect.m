function [edge_alpha,one_cells] = AlphaCellsSelect(DT,GoodEdges,VV,VC,GoodIndex)
%
...
% Hold the complete set of one_cells in case the user wants to redo the
% selection.
...
while alpha_complex_option == 1;
   ...
   % This is in case the user is re-doing the selection.
   ...
   switch alpha_select_option
      ...
      otherwise
         ...
         % This section is experimental and not fully tested yet.  Results
         % not guaranteed.
   ...
   % This final section plots the result of the above alpha complex
   ...
   % remind the user what their selection choice was.
   ...
   % This choice allows the user to decide if they want to redo the
   % selection or not.
